...
export data_remote_files_siv=.*_siv_api_.*
export data_remote_files_ivt=.*_ivt_api_.*
...
index-direct-load: index-direct-load-siv index-direct-load-ivt
	echo "Index direct load"

index-direct-load-siv: install-prerequisites-injection wait-index
	@echo "index-direct-load-siv"
