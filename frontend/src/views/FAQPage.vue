...
import {FAQ_THEMES, FAQ_THEMES_OPTIONS} from '@/constants/faq.js'

import {mailTo} from '@/utils/email.js'
import {ABOUT_UNPAID_PV_EMAIL, CAS_TOULOUSE_EMAIL} from '@/constants/email.js'
    ...
    >
      <DsfrAccordionsGroup>
        <li>
          ...
          >
            <p>
              HistoVec vous permet de valoriser votre offre en fournissant gratuitement un rapport d’historique officiel
              qui rassurera vos acheteurs potentiels.
    ...
    >
      <DsfrAccordionsGroup>
        <li>
          ...
          >
            ...
            <ul class="fr-ml-4w  fr-pl-0">
              <li>
                Sur la page Propriétaire, remplissez le formulaire avec les informations figurant sur la carte grise en
                cours de validité.
                Si le véhicule appartient à une entreprise, une collectivité, ou une association, cliquez sur « Personne
                morale » et renseignez, le cas échéant, le numéro de SIREN.
              </li>
              <li>
        ...
        <li>
          ...
          >
            <p>
              Seul le titulaire du certificat d'immatriculation en cours de validité peut générer le rapport HistoVec de
              son véhicule, qu'il choisit de transmettre à des tiers.
            </p>
            <p>
              Si vous n’êtes pas le titulaire de la carte grise en cours de validité, vous ne pouvez pas consulter
              directement les données HistoVec pour ce véhicule. Il vous est possible de demander au propriétaire actuel
              la transmission par mél du rapport HistoVec en sélectionnant le profil acheteur sur la page d'accueil du
              site HistoVec.
            </p>
            <p>
        ...
        <li>
          ...
          <DsfrAccordion
            ...
            @expand="expandedId = $event"
          >
            <p>Propriétaire du véhicule et titulaire du certificat d'immatriculation sont deux noti ons différentes
              :</p>
            <ul class="fr-ml-4w  fr-pl-0">
        ...
        <li>
          ...
          >
            <p>
              ...
              validité et son ou ses prénoms. Assurez-vous de reprendre bien l’orthographe telle qu’elle figure sur la
              carte grise et vérifiez le nombre de prénoms.
            </p>
            <p>
              Pour les véhicules avec un ancien numéro d'immatriculation, reprenez les nom et prénom exactement comme
              ils sont indiqués sur la carte grise, sans préciser "M et Mme" par exemple.
            </p>
          </DsfrAccordion>
        </li>
        <li>
          ...
          >
            ...
            <p>
              ...
              formulaire de recherche en indiquant, le cas échéant, le n° SIREN de la société qui vous loue le véhicule.
            </p>
            <p>
        ...
        <li>
          ...
          >
            ...
            <p>
              Si vous ne disposez plus de la carte grise en cours de validité, nous vous invitons à contacter l'Agence
              nationale des titres sécurisés qui délivre ce document et les duplicatas :
            </p>
            <ul class="fr-ml-4w  fr-pl-0">
              <li>
                <a
      ...
      <DsfrAccordionsGroup>
        ...
        <li>
          ...
          >
            ...
            <ul class="fr-ml-4w  fr-pl-0">
              <li>
                Les nom et prénom du titulaire actuel de la carte grise (nom de naissance, orthographe, nombre de
                prénoms…) ;
              </li>
              <li>
              ...
              <li>
                ...
                <ul class="fr-ml-4w  fr-pl-0">
                  <li>
                    Si la carte grise a précédemment été déclarée perdue ou volée, un duplicata vous a été adressé. Il
                    convient d'indiquer sur HistoVec le n° de formule de ce dernier certificat d'immatriculation.
                  </li>
                  <li>
              ...
              <li>
                ...
                de la carte grise, et non la date de 1ère immatriculation du véhicule.
              </li>
            </ul>
          </DsfrAccordion>
        </li>
        ...
        <li>
          ...
          >
            ...
            <p>
              Si vous souhaitez disposer du certificat de situation administrative, nous vous invitons à le télécharger
              auprès de l’ANTS (Agence Nationale des Titres Sécurisés) en suivant
              <a
                class="fr-link"
                href="https://siv.interieur.gouv.fr/map-usg-ui/do/accueil_certificat"
                rel="noopener noreferrer"
          ...
          >
            <ul class="fr-ml-4w  fr-pl-0">
              ...
              <li>
                ...
                l'absence de la donnée dans les anciens fichiers d'immatriculation (p. ex. certains véhicules anciens).
              </li>
              <li>
              ...
              <li>
                ...
                carte grise pour la mettre à son nom.
              </li>
              <li>
        ...
        <li>
          ...
          >
            <p>
              ...
              enregistrés que les sinistres déclarés à l’assureur et pour lesquels un expert a enregistré une procédure
              VRC (Véhicule à Réparation Contrôlée).
            </p>
          </DsfrAccordion>
        </li>
        <li>
        ...
        <li>
          ...
          >
            <p>
              ...
              transmis en tant que tels dans le système d'immatriculation des véhicules (SIV). Dès lors, si vous achetez
              le véhicule, n'hésitez pas à demander au vendeur s'il est en possession du rapport d'expertise.
            </p>
          </DsfrAccordion>
        </li>
        <li>
      ...
      <DsfrAccordionsGroup>
        ...
        <li>
          ...
          >
            ...
            <p>
              HistoVec affiche par conséquent les résultats de l’ensemble des contrôles techniques et des kilométrages
              relevés lors de ces contrôles.
            </p>
            <p>
              Si les données relatives aux contrôles techniques ou aux kilométrages de ce véhicule vous semblent
              incorrectes, nous vous invitons à vous adresser :
            </p>
            ...
            <ul class="fr-ml-4w  fr-pl-0">
              ...
              <li>
                si vous étiez déjà propriétaire du véhicule à la date de ces contrôles, au centre de contrôle technique
                qui les a réalisés.
              </li>
              <li>
