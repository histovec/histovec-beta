      ...
      <div class="container">
        <div class="row">
          ...
          <div class="main col-md-12">
            <!-- page-title start -->
            <h3 class="title">
              <span class="text-defaut">404</span>
            </h3>
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-lg-12 no-margin">
                ...
                <p>Nous vous invitons à revenir en arrière et d'essayer une autre route.</p>
              </div>
            </div>
            <!-- row -->
          </div>
...
export default {
  created () {
    this.$http.put(this.apiUrl + 'log/404/' + localStorage.getItem('userId') + '/' + this.$route.path.replace(/^\/\w+\//, '')).then(() => {}, () => {})
  }
}
</script>
