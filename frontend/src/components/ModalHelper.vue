    ...
    <div class="modal-mask">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <button type="button" class="close" @click="close()"><span aria-hidden="true">&times;</span><span class="sr-only">Fermer</span></button>
            ...
            <div class="modal-footer"> <a class="btn radius-30 btn btn-animated btn-default" @click="close()">Fermer <i class="fa fa-close"></i></a> </div>
            </div>
        </div>
        </div>
