context('Rapport vehicule cas simple - onglet Contrôles techniques', () => {
  ...
  it("Affichage de l'onglet Contrôles techniques - contenue", () => {
    cy.get("div[id*='report-tab-content-5']")
      .find("div[class='fr-grid-row fr-grid-row--gutters']")
      .find("div[class='fr-col-12 fr-col-sm-2 fr-col-md-2 fr-col-lg-2 fr-col-xl-2 fr-pb-0 fr-blue-text']")
      ...
      .parent()
      .find("div[class='fr-col-12 fr-col-sm-6 fr-col-md-6 fr-col-lg-5 fr-col-xl-5 fr-pb-0 fr-blue-text']")
      .should('have.length', 3)
      .each(($el, index) => {
        cy.wrap($el)
      ...
      .parent()
      .find("div[class='fr-col-4 fr-col-sm-2 fr-col-md-2 fr-col-lg-2 fr-col-xl-2 fr-blue-text']")
      .should('have.length', 3)
      .each(($el, index) => {
        cy.wrap($el)
      ...
      .parent()
      .find("div[class='fr-col-8 fr-col-sm-2 fr-col-md-2 fr-col-lg-3 fr-col-xl-3 fr-pb-2w fr-blue-text']")
      .should('have.length', 3)
      .each(($el, index) => {
        cy.wrap($el)
