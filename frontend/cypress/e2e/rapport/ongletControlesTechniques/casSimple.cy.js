context('Rapport vehicule cas simple - onglet Contrôles techniques', () => {
  ...
  it("Affichage de l'onglet Contrôles techniques - structure", () => {
    cy.get("div[id*='report-tab-content-5']")
      ...
      .find("div[class='fr-col-2 fr-col-md-2 fr-col-lg-2 fr-col-xl-2 fr-pb-0']")
      .should('have.length', 1)
      .find("h6")
      .should('have.length', 1)
      .contains("Date")
      .parent()
      .parent()
      .find("div[class='fr-col-3 fr-col-md-6 fr-col-lg-5 fr-col-xl-5 fr-pb-0']")
      .should('have.length', 1)
      .find("h6")
      .should('have.length', 1)
      .contains("Nature")
      .parent()
      .parent()
      .find("div[class='fr-col-3 fr-col-md-2 fr-col-lg-2 fr-col-xl-2 fr-pb-0']")
      .should('have.length', 1)
      .find("h6")
      .should('have.length', 1)
      .contains("Résultat")
      .parent()
      .parent()
      .find("div[class='fr-col-2 fr-col-md-2 fr-col-lg-3 fr-col-xl-3 fr-pb-3w']")
      .should('have.length', 1)
      .find("h6")
      .should('have.length', 1)
  ...
  it("Affichage de l'onglet Contrôles techniques - contenue", () => {
    cy.get("div[id*='report-tab-content-5']")
      .find("div[class='fr-grid-row fr-grid-row--gutters']")
      .find("div[class='fr-col-12 fr-col-sm-2 fr-col-md-2 fr-col-lg-2 fr-col-xl-2 fr-pb-0 fr-text--bleu']")
      ...
      .parent()
      .find("div[class='fr-col-12 fr-col-sm-6 fr-col-md-6 fr-col-lg-5 fr-col-xl-5 fr-pb-0 fr-text--bleu']")
      .should('have.length', 3)
      .each(($el, index) => {
        cy.wrap($el)
      ...
      .parent()
      .find("div[class='fr-col-4 fr-col-sm-2 fr-col-md-2 fr-col-lg-2 fr-col-xl-2 fr-text--bleu']")
      .should('have.length', 3)
      .each(($el, index) => {
        cy.wrap($el)
          .find("p[class='fr-badge fr-badge--success fr-badge--no-icon']")
          .should('have.length', 1)
          .find("span")
          .should('have.text', "Favorable")
      })
      .parent()
      .find("div[class='fr-col-8 fr-col-sm-2 fr-col-md-2 fr-col-lg-3 fr-col-xl-3 fr-pb-2w fr-text--bleu']")
      .should('have.length', 3)
      .each(($el, index) => {
        cy.wrap($el)
