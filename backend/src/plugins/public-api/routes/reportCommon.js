...
export const generateReportRoute = ({ path, logLabel, payloadSchema }) => {
  return {
    ...
    handler: async (request, h) => {
      ...
      syslogLogger.info({ key: 'payload_data', tag: logLabel, value: (anonymizeIdentite({ logLabel, alreadyHasIdAndKey, uuid, typeImmatriculation, nom, prenoms, raisonSociale, siren, numeroImmatriculation, numeroFormule, dateEmissionCertificatImmatriculation, id, key })) })
