...
export const generateReportRoute = ({ path, logLabel, payloadSchema }) => {
  return {
    ...
    handler: async (request, h) => {
      ...
      syslogLogger.info({ key: 'payload_code', tag: logLabel, value: { isInvalidCode, uuid, id, key, code } })
      ...
      syslogLogger.info({ key: 'payload_data', tag: logLabel, value: (anonymizedIdentite({ logLabel, alreadyHasIdAndKey, uuid, typeImmatriculation, nom, prenoms, raisonSociale, siren, numeroImmatriculation, numeroFormule, dateEmissionCertificatImmatriculation, id, key })) })
      ...
      const { sivData, utacData: rawAnonymizedControlesTechniques, error, message } = res
      ...
      syslogLogger.info({
        ...
        value: {
          sivData,
          rawAnonymizedControlesTechniques,
          error,
          message,
