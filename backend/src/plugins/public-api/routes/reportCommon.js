...
import { PLAQUE_SIV_REGEX } from '../../../constant/regex.js'
...
export const generateReportRoute = ({ path, logLabel, payloadSchema }) => {
  return {
    ...
    handler: async (request, h) => {
      ...
      syslogLogger.debug({ key: 'payload', tag: logLabel, value: { nom, prenoms, raisonSociale, siren, plaqueImmatriculation, numeroFormule, dateEmissionCertificatImmatriculation, id, key } })
