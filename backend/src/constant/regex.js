...
export const DATE_EN_REGEX = /^\d{4}[-](0?[1-9]|1[012])[-](0?[1-9]|[12][0-9]|3[01])$/
...
export const NUMERO_IMMATRICULATION_FNI_ANONIMISE_REGEX = /^[a-zA-Z][*][*][*][*][*][*][*][*][a-zA-Z]$/
export const NUMERO_IMMATRICULATION_SIV_ANONIMISE_REGEX = /^[a-zA-Z][*][*][*][*][*][*][*][a-zA-Z]$/
export const NUMERO_IMMATRICULATION_ANONIMISE_REGEX = new RegExp(`${NUMERO_IMMATRICULATION_FNI_ANONIMISE_REGEX.source}|${NUMERO_IMMATRICULATION_SIV_ANONIMISE_REGEX.source}`)
export const UTAC_NUMERO_IMMATRICULATION_REGEX = /^[A-Z]{2}-[0-9]{3}-[A-Z]{2}|[0-9]{1,4}[ ]{0,}[A-Z]{1,3}[ ]{0,}[0-9]{1,3}$/

// Format de l'identifiant/clefs 8-4-4-4-12
export const ID_REGEX = /^(?:[A-Za-z\d+/]{4})*(?:[A-Za-z\d+/]{3}=|[A-Za-z\d+/]{2}==)?-(?:[A-Za-z\d+/]{4})*(?:[A-Za-z\d+/]{3}=|[A-Za-z\d+/]{2}==)?$/
export const CLEF_ACHETEUR_REGEX = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/

// Format des informations du véhicule
export const NUMERO_FORMULE_REGEX = /^(\d{2,4}[a-zA-Z]{2}\d{5})$/
export const VIN_REGEX = /^[A-HJ-NPR-Z\d]{1,17}$/

// Format des informations du propriétaire
export const NUMERO_SIREN_REGEX = /^\d{9}$/

// Format des informations de l'API
