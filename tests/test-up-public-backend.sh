...
echo "[ENV VAR] USE_PREVIOUS_MONTH_FOR_DATA = ${USE_PREVIOUS_MONTH_FOR_DATA} -- (default to false)"
echo "[ENV VAR] PREVIOUS_MONTH_SHIFT = ${PREVIOUS_MONTH_SHIFT} -- (default to 1)"
